...
class LanguageTa extends BaseLanguage {
  @override String get appName => 'மைட்டி ரைடர்';
  ...
  @override String get createAccount => 'உங்கள் கணக்கை துவங்குங்கள்';
  ...
  @override String get editProfile => 'சுயவிவரத்தைத் திருத்து';
  ...
  @override String get capacity => 'திறன்';
  @override String get paymentMethod => 'கட்டண முறை';
  @override String get chooseYouPaymentLate => 'இப்போது அல்லது தாமதமாக உங்களுக்கு கட்டணம் தேர்வு செய்யவும்';
  @override String get enterPromoCode => 'விளம்பர குறியீட்டை உள்ளிடவும்';
  @override String get confirm => 'உறுதிப்படுத்தவும்';
  @override String get forInstantPayment => 'உடனடி கட்டணத்திற்கு';
  @override String get bookNow => 'பதிவு';
  ...
  @override String get updatePaymentStatus => 'கட்டண நிலையைப் புதுப்பிக்கவும்';
  @override String get waitingForDriverConformation => 'டிரைவர் உறுதிப்படுத்த காத்திருக்கிறது';
  @override String get continueNewRide => 'புதிய சவாரி தொடரவும்';
  @override String get payToPayment => 'கட்டணத்திற்கு பணம் செலுத்துங்கள்';
  ...
  @override String get wouldYouLikeToAddTip => 'உதவிக்குறிப்பைச் சேர்க்க விரும்புகிறீர்களா?';
  @override String get addMoreTip => 'மேலும் உதவிக்குறிப்பைச் சேர்க்கவும்';
  @override String get addMore => 'மேலும் சேர்க்கவும்';
  ...
  @override String get aboutDriver => 'டிரைவர் பற்றி';
  ...
  @override String get whatWouldYouLikeToGo => 'நீங்கள் எங்கு செல்ல விரும்புகிறீர்கள்?';
  @override String get enterYourDestination => 'உங்கள் இலக்கை உள்ளிடவும்';
  @override String get currentLocation => 'தற்போதைய இடம்';
  @override String get destinationLocation => 'இலக்கு இடம்';
  @override String get chooseOnMap => 'வரைபடத்தில் தேர்வு செய்யவும்';
  ...
  @override String get lookingForNearbyDrivers => 'அருகிலுள்ள டிரைவர்களைத் தேடுகிறது';
  @override String get weAreLookingForNearDriversAcceptsYourRide => 'உங்கள் சவாரிக்கு அருகிலுள்ள டிரைவர்களை நாங்கள் தேடுகிறோம்';
  @override String get get => 'பெறு';
  @override String get rides => 'சவாரி';
  @override String get people => 'மக்கள்';
  @override String get done => 'முடிந்தது';
  @override String get availableOffers => 'கிடைக்கும் சலுகைகள்';
  @override String get off => 'ஆஃப்';
  @override String get sendOTP => 'OTP ஐ அனுப்பு';
  @override String get carModel => 'கார் மாடல்';
  @override String get sos => 'சோஸ்';
  @override String get driverReview => 'இயக்கி விமர்சனம்';
  @override String get signInUsingYourMobileNumber => 'உங்கள் \ nmobile எண்ணைப் பயன்படுத்தி உள்நுழைக';
  @override String get otp => 'OTP';
  @override String get newRideRequested => 'புதிய சவாரி கோரப்பட்டது';
  ...
  @override String get inProgress => 'முன்னேற்றத்தில்';
  ...
  @override String get mostReliableMightyRiderApp => 'மிகவும் நம்பகமான மைட்டி ரைடர் பயன்பாடு';
  ...
  @override String get paymentVia => 'வழியாக கட்டணம்';
  @override String get demoMsg => 'இந்த செயலைச் செய்ய சோதனையாளர் பங்கு அனுமதிக்கப்படவில்லை';
  @override String get findPlace => 'ஒரு இடத்தைக் கண்டுபிடி ...';
  @override String get pleaseWait => 'தயவுசெய்து காத்திருங்கள்';
  @override String get selectPlace => 'இடத்தைத் தேர்ந்தெடுக்கவும்';
  @override String get placeNotInArea => 'பரப்பளவில் வைக்கவும்';
  @override String get youCannotChangePhoneNumber => 'நீங்கள் தொலைபேசி எண்ணை மாற்ற முடியாது';
  @override String get complainList => 'பட்டியல் பட்டியல்';
  @override String get writeMsg => 'செய்தி எழுதுங்கள்';
  @override String get pleaseEnterMsg => 'செய்தியை உள்ளிடவும்';
  @override String get viewAll => 'அனைத்தையும் காட்டு';
  ...
  @override String get driverInformation => 'இயக்கி தகவல்';
  @override String get nameFieldIsRequired => 'பெயர் புலம் தேவை';
  @override String get phoneNumberIsRequired => 'தொலைபேசி எண் தேவை';
  @override String get enterName => 'பெயரை உள்ளிடுக';
  @override String get enterContactNumber => 'தொடர்பு எண்ணை உள்ளிடவும்';
  ...
  @override String get lblCarNumberPlate => 'கார் எண் தட்டு';
  @override String get lblRide => 'சவாரி';
  @override String get lblRideInformation => 'சவாரி தகவல்';
  @override String get lblWhereAreYou => 'நீங்கள் எங்கே?';
  @override String get lblDropOff => 'கைவிடவும்';
  @override String get lblDistance => 'தூரம்:';
  @override String get lblSomeoneElse => 'வேறு யாரோ';
  @override String get lblYou => 'நீங்கள்';
  @override String get lblWhoRidingMsg => 'சவாரி உறுதிப்படுத்தவும், பயணத் தகவல்களை உறுதிப்படுத்தவும்';
  @override String get lblNext => 'அடுத்தது';
  @override String get lblLessWalletAmount => 'குறிப்பு: உங்கள் பணப்பையில் போதுமான சமநிலை இல்லை. இல்லையெனில் தொகையைச் சேர்க்கவும், நீங்கள் பணம் வழியாக செலுத்த வேண்டும்.';
  @override String get lblPayWhenEnds => 'பயணம் முடிவடையும் போது செலுத்துங்கள்';
  ...
  @override String get minimumFare => 'குறைந்தபட்ச கட்டணம்';
  @override String get cancelRide => 'சவாரி ரத்துசெய்';
  @override String get cancelledReason => 'ரத்து செய்யப்பட்ட காரணம்';
  @override String get selectReason => 'காரணத்தைத் தேர்ந்தெடுக்கவும்';
  @override String get writeReasonHere => 'காரணத்தை இங்கே எழுதுங்கள் ...';
  @override String get driverGoingWrongDirection => 'இயக்கி தவறான திசை செல்கிறது';
  @override String get pickUpTimeTakingTooLong => 'அதிக நேரம் எடுக்கும் நேரத்தை எடுத்துக் கொள்ளுங்கள்';
  @override String get driverAskedMeToCancel => 'டிரைவர் என்னை ரத்து செய்யச் சொன்னார்';
  @override String get others => 'மற்றவைகள்';
  @override String get baseFare => 'அடிப்படை கட்டணம்';
  @override String get perDistance => 'ஒரு தூரத்திற்கு';
  @override String get perMinDrive => 'ஒரு நிமிட பயணத்திற்கு';
  @override String get perMinWait => 'ஒரு நிமிடத்திற்கு காத்திருங்கள்';
  @override String get min => 'நிமிடம்';
  @override String get unsupportedPlateForm => 'ஆதரிக்கப்படாத தளம்';
  ...
  @override String get bankInfoUpdated => 'வங்கி தகவல் புதுப்பிப்பு வெற்றிகரமாக';
  ...
  @override String get servicesNotFound => 'சேவைகள் கிடைக்கவில்லை';
  ...
  @override String get whoWillBeSeated => 'யார் அமர்ந்திருப்பார்கள்?';
  ...
  @override String get passwordLength => 'கடவுச்சொல் நீளம் குறைந்தபட்சம் 8 ஆக இருக்க வேண்டும்';
  @override String get bothPasswordNotMatch => 'இரண்டு கடவுச்சொல்லையும் பொருத்த வேண்டும்';
  @override String get missingBankDetail => 'வங்கி விவரங்களைக் காணவில்லை. திரும்பப் பெறும் தொகையை உங்கள் சுயவிவரத்தை முடிக்கவும்';
  @override String get close => 'நெருக்கமான';
  @override String get copied => 'நகலெடுக்கப்பட்டது!';
}
