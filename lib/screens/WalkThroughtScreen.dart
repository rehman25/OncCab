...
class WalkThroughScreenState extends State<WalkThroughScreen> {
  ...
  List<WalkThroughModel> walkThroughClass = [
    WalkThroughModel(name: walkthrough_title_1, text: walkthrough_subtitle_1, img: walkthrough_image_1),
    WalkThroughModel(name: walkthrough_title_2, text: walkthrough_subtitle_2, img: ic_walk2),
    WalkThroughModel(name: walkthrough_title_3, text: walkthrough_subtitle_3, img: walkthrough_image_3)
  ];
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8),
                    Text(walkThroughClass[currentPage].text.toString(), style: secondaryTextStyle(size: 14, color: Colors.white), textAlign: TextAlign.center),
                  ],
                ),
                SizedBox(height: 32),
