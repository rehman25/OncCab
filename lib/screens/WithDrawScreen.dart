                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: 16),
                              Expanded(child: Text(printAmount(totalAmount.toStringAsFixed(digitAfterDecimal)), style: boldTextStyle(size: 22),textAlign: TextAlign.end)),
                            ],
                          ),
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        SizedBox(height: 4),
                                        Text(printAmount(data.amount!.toStringAsFixed(digitAfterDecimal)), style: boldTextStyle(size: 14)),
                                      ],
                                    )
                                  ],
                                ),
                                ...
                                children: appStore.walletPresetTopUpAmount.split('|').map((e) {
                                  return inkWellWidget(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text(printAmount(e), style: boldTextStyle(color: currentIndex == appStore.walletPresetTopUpAmount.split('|').indexOf(e) ? Colors.white : primaryColor)),
                                    ),
                                  );
                                }).toList(),
                              ),
